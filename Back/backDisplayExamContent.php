<?php
    ...
    $stmt2 = "SELECT Question_Bank.questionName, Question_Bank.questionDescription FROM Question_Bank INNER JOIN examContentTable ON Question_Bank.questionId = examContentTable.questionId WHERE examContentTable.examId = '$examId'";
