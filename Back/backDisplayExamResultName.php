<?php
    ...
    //$stmt = "select * from `studentExamResult`"; 
    $stmt = "SELECT examTable.examName FROM examTable INNER JOIN studentExamResult ON examTable.examId = studentExamResult.examId";
