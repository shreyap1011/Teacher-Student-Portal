...
$stmt = "insert into `Question_Bank` (`questionName`, `questionDescription`, `questionFunction`, `questionCateogory`, `difficulty`, `totalTestCase`, `constraint`) VALUES ('$questionName', '$questionDescription', '$questionFunction', '$questionCateogory', '$difficulty', '$n', '$constraint')";
